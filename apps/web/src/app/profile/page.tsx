...
export default function ProfilePage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <Link href="/studio/games" className="glass glass-hover flex items-center gap-3 p-4">
        <span className="grid h-9 w-9 shrink-0 place-items-center rounded-xl bg-neon-magenta/15 text-neon-magenta"><Icon name="pencil" size={16} /></span>
        <div className="flex-1">
          <div className="font-display text-sm font-bold text-white">Your games &amp; royalties</div>
          <div className="text-xs text-slate-500">Manage what you&apos;ve published and claim what it earned</div>
        </div>
