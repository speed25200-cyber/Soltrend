...
@Module({
  ...
  providers: [SessionStore, FairService, GamesService, MetricsService, ComplianceService, RealtimeGateway, PlazaGateway, DuelGateway, JackpotGateway, ShowdownGateway],
})
